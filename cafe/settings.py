...
SECRET_KEY = 'django-insecure-=6$k+@^=wd3zuq9sz(+pn=9e-^^(s4e18o*@vr9jodf==q!$@1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'cafe777.onrender.com',]
...
DATABASES = {
    ...
    'default': {
	    ...
	    'NAME': 'cafe_tkzk',
	    'USER' : 'cafe_admin',
	    'PASSWORD' : 'gHEy9BRS3dnm0TQcV1u36Ah9ZLGU2RJu',
	    'HOST' : 'dpg-clhd26ef27hc739q5djg-a.frankfurt-postgres.render.com',
	    'PORT' : '5432',
    }
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'dznh0fsyy',
    'API_KEY': '993116439563533',
    'API_SECRET': 'HvrO0tvMEpjxGyCGPMgRuOeoXSY',
}
